...
export default function Home() {
  ...
  function applyBackgroundFilter(preset: { name: string; filter: { backgroundBlur: number; backgroundBrightness: number; backgroundContrast: number; backgroundSaturation: number; backgroundTemperature: number; backgroundVignette: number; backgroundGrain: number } }) {
