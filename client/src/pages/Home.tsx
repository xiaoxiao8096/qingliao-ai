...
export default function Home() {
  ...
  const { preference, setPreference, accent, setAccent, fontScale, setFontScale, resetAppearance } = useThemePreference();
